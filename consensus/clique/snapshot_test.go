...
func (r *testerChainReader) Config() *config.ChainConfig                 { return config.AllProtocolChanges }
...
func (r *testerChainReader) GetHeaderByNumber(number uint64) *types.Header {
	if number == 0 {
		return blockchain.GetHeader(r.db, blockchain.GetCanonicalHash(r.db, 0), 0)
	}
	panic("not supported")
}
