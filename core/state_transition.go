...
func (st *StateTransition) replenishGas() error {
	st.gas += (*big.Int)(st.gp).Uint64()
	st.initialGas.SetUint64(st.gas)
	return nil
}
...
func (st *StateTransition) TransitionDb() (ret []byte, requiredGas, usedGas *big.Int, failed bool, err error) {
	...
	// Pay intrinsic gas
	// TODO convert to uint64
	intrinsicGas := IntrinsicGas(st.data)
